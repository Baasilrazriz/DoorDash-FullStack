...
builder.Services.AddDbContext<ApplicationDbContext>(options =>options.UseSqlServer(builder.Configuration.GetConnectionString("Data Source=IRFAN\\RAZRIZ;Initial Catalog=DoorDash;Integrated Security=True;Encrypt=True;Trust Server Certificate=True")));
